...
const ProfileCard = (currentUser: any) => {
  ...
  return (
    <div className="relative w-full p-4  rounded-2xl bg-white ">
      <button
        onClick={() => toggleEdit()}
        className="absolute z-10 w-fit h-fit items-center  top-4 right-4 text-white bg-black rounded-full px-2"
      >
        Edit
      </button>
      <div className="flex ">
        ...
        <div className="flex flex-col p-4 space-y-2">
          <div className="flex flex-wrap gap-2">
            ...
            <span className="px-2 py-1 rounded-full text-black border ">
              {role}
            </span>
          </div>
