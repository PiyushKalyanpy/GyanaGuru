...
const OurTeam = () => {
  ...
  <div class="mx-auto max-w-screen-xl px-4 md:px-8">
    <div class="mb-10 md:mb-16">
      ...
      <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Meet the driving force behind our success - a diverse team united by passion and expertise. Discover the faces behind our brand, each contributing their unique talents to deliver exceptional experiences.</p>
    </div>
