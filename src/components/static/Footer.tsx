...
export default function Footer () {
  ...
  //     <div className='flex flex-col lg:flex-row p-4 lg:justify-around flex-wrap'>
  ...
  //       </div>
    ...
    //     </div>
    //   </div>
    //   <div className='flex flex-col lg:flex-row justify-center w-full border-y-2 items-center gap-8 border-black  '>
    ...
    <footer className="bg-gray-100 dark:bg-zinc-700">
        ...
        <div className="flex flex-col lg:flex-row p-4 lg:justify-around flex-wrap">
          ...
          Quick Links
            ...
            <ul className="list-none m-0 p-0">
              ...
              <li className="leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                <Link href="/about-us" className={hoverEffect}>
              About Us
                </Link>
              </li>
              <li className="leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
      ...
      <div className="flex flex-col lg:flex-row justify-center w-full border-y-2 items-center gap-8 border-black p-4">
