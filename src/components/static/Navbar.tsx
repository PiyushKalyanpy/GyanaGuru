...
export default function Navbar() {
  ...
  return (
    <div className='fixed top-0 z-0 w-full border-b-2 border-white bg-white/30 backdrop-blur-md dark:bg-neutral-950/50 dark:border-zinc-700'>
      <div className='flex flex-row items-center justify-between w-full px-6 py-4 lg:px-20 '>
        ...
        <div className='flex-row items-center hidden gap-4 lg:flex'>
          ...
          >
            ...
            <span className='p-2 text-white bg-black rounded-full dark:text-zinc-800 dark:bg-zinc-50 material-symbols-outlined'>
              arrow_outward
            </span>
          </div>
          <div className='mt-1'>
