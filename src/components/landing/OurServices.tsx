...
const OurServices = () => {
	...
	return (
		...
		<div id="ourservices" className="relative lg:px-20 dark:bg-neutral-950">
			...
			<div className="flex flex-col justify-center items-center">
				<h1 className="text-4xl font-semibold font-archivo text-slate-900 dark:text-zinc-50 p-4">
					Our Services
				</h1>
				...
				<div className="flex flex-col lg:flex-row gap-8 w-full items-center">
					...
					<div className="flex flex-col p-10 space-y-8 mx-auto z-10">
						<div className="text-center lg:text-start">
							<h2 className="text-xl lg:text-3xl font-archivo text-slate-900 dark:text-zinc-50">
								Success doesn t have to be hard
							</h2>
							<h2 className="text-3xl font-bold font-archivo text-slate-900 dark:text-zinc-50">
								We make it easy.
							</h2>
						</div>
						<h2 className="text-xl font-archivo text-zinc-700 text-center lg:text-start dark:text-zinc-100">
