        ...
        <div className="w-full max-w-screen-lg p-4 mx-auto">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={
                            currentStep === steps.length - 1 ? handleSave : handleNext
                        }
                        className="px-4 py-2 text-white bg-blue-500 rounded-full disabled:opacity-50"
                    >
                        {
                ...
                <div className="flex items-center w-full">
                    {steps.map((step, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`flex items-center ${index !== steps.length - 1 ? "w-full" : "w-fit"
                                    }`}
                            >
                                <div
                                    className={`rounded-full h-8 w-8 flex items-center justify-center ${currentStep > index
                                ...
                                {index !== steps.length - 1 ? (
                                    <div
                                        className={`flex h-1 rounded-full ${currentStep > index ? "bg-blue-500" : "bg-gray-200"
