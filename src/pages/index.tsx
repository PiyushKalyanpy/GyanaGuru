	...
	return (
		<>
			<Head>
				...
				<meta
					name="title"
					content="GyanaGuru - Empower Yourself Through Knowledge"
				/>
				<meta
					name="description"
				...
				<meta
					name="keywords"
					content="GyanaGuru, online learning platform, educational resources, wide range of subjects, high-quality courses, interactive quizzes, exercises, gamification elements, social features, active participation, collaboration, learners"
				/>
				...
				<meta
					...
					content="Join GyanaGuru and empower yourself through knowledge. Explore a wide range of high-quality educational resources, interactive quizzes, and social features for active learning and collaboration."
				/>
				<meta
					property="og:image"
					content="https://gyanaguru.vercel.app/icons/logo128.svg"
				/>{' '}
				{/* Replace with the actual preview image URL */}
		...
		<div className="fixed z-50 flex items-center w-full h-screen p-4 bg-black/50 backdrop-blur-sm">
			<div className="flex flex-col items-center w-full p-8 m-auto space-y-10 bg-white lg:w-1/2 rounded-3xl">
				...
				<span className="text-center text-md lg:mx-10 lg:text-xl text-zinc-600">
					Please refrain from pushing your code for now as we are in the process
					of migrating from Next.js 12 to Next.js 13. This will help minimize
					conflicts and ensure a smoother transition. Thank you for your
					cooperation!{' '}
				</span>
