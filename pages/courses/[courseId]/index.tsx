      ...
      <div className="grid grid-cols-12 w-full h-screen overflow-auto bg-zinc-100">
        <div className="col-span-9 bg-slate-50 h-screen p-8 space-y-8 overflow-y-scroll ">
          <div className="relative h-3/4">
            {/* <iframe
              id="video-player"
              className="absolute w-full h-full  rounded-2xl shadow-lg z-10 bg-white"
              width="420"
              height="345"
             ...
             */}
            <YouTube
              className="absolute w-full h-full overflow-hidden  rounded-2xl shadow-lg z-10 bg-white"
              videoId="doSFDItcQrk"
              opts={opts}
          ...
          <TitleElement
            title="Prepare for placement and internships in 4 months"
  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex-1">
        {/* Video Player */}
        <div className="relative h-0 pb-9/16 bg-white">
          <video
