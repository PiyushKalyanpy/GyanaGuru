...
const LandingThreeGrid = () => {
  ...
  return (
    <div className="grid grid-cols-11 h-96 mx-20  gap-4 mb-20">
      {/* Showcase 1 */}
      <div className="card transform translate-x-full opacity-0 transition duration-500 ease-in-out flex  col-span-4 bg-[url('/images/landing0101.jpg')] bg-orange-50 rounded-3xl">
      ...
      {/* Showcase 4 */}
      <div className="card transform translate-x-full opacity-0 transition duration-500 ease-in-out  flex col-span-4 bg-[url('/images/landing0102.jpg')] object-cover overflow-hidden bg-orange-100 rounded-3xl">
      ...
      {/* Showcase 3 */}
      <div className="card transform translate-x-full opacity-0 transition duration-500 ease-in-out col-span-3  bg-slate-200 rounded-3xl">
        <div className="flex flex-col justify-end items-end w-full">
