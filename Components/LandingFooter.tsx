    ...
    <div className="mb-6 mt-8">
        ...
        <div className="mb-24 mt-8">
           ...
           <ul>
                ...
                <li className="leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https:twitter.com" className={hoverEffect}><AiFillTwitterCircle className="mr-1 transition ease duration-200 group-hover:text-sky-500" />Twitter</a>
                </li>
                <li className="leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https://www.linkedin.com/in/piyush-kalyan/" className={hoverEffect}><AiFillLinkedin className="mr-1 transition ease duration-200 group-hover:text-sky-600" />Linkedin</a>
                </li>
                <li className="leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https:instagram.com" className={hoverEffect}><AiFillInstagram className="mr-1 transition ease duration-200 group-hover:text-rose-500" />Instagram</a>
                </li>
                <li className="leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https:facebook.com" className={hoverEffect}><AiFillFacebook className="mr-1 transition ease duration-200 group-hover:text-blue-700" />Facebook</a>
                </li>
             </ul>
        </div>
