...
<div className="flex justify-around flex-wrap">
    ...
    <div className="mb-6 mt-8">
        ...
        <div className="mb-24 mt-8">
           ...
           <ul>
                <li className="social github leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                ...
                <li className="social twitter leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https:twitter.com" className={hoverEffect}><AiFillTwitterCircle className="mr-1" />Twitter</a>
                </li>
                <li className="social linkedin leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https://www.linkedin.com/in/piyush-kalyan/" className={hoverEffect}><AiFillLinkedin className="mr-1" />Linkedin</a>
                </li>
                <li className="social instagram leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
                   <a href="https:instagram.com" className={hoverEffect}><AiFillInstagram className="mr-1" />Instagram</a>
                </li>
                <li className="social facebook leading-8 text-base text-black text-opacity-80 dark:text-zinc-50">
