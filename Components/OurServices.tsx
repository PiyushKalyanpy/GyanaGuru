...
const CourseCard = ({ courseName }: any) => {
  return (
    <div className="flex border-2 bg-sky-200 font-medium border-slate-700 hover:border-black hover:scale-[1.04] hover:bg-sky-300 hover:font-bold rounded-full px-4 py-2">
