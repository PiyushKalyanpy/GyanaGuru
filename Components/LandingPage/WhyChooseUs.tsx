  ...
  return (
    <div id="whychooseus" className="px-20 mt-40 dark:bg-neutral-950">
      ...
      <div className="grid grid-cols-6  gap-8 w-full items-center">
        <div className="col-span-4 grid grid-cols-3 gap-8 backgroundColor:zinc-80 dark : backgroundColor: zinc-80  ">
...
const InfoCard = ({ title, description }: any) => {
  ...
  return (
    ...
    <div className="  p-4  hover:bg-zinc-80 dark:hover:bg-zinc-80 transition-colors font-archivo rounded-3xl ">
